            ...
            <div className="sticky inset-0 z-10 flex h-fit   justify-between    bg-white/60  backdrop-blur-md ">
                <div className="flex w-full flex-col ">
                    <div className="mx-2 flex items-center gap-10">
                        <div className="w-fit rounded-full p-1 hover:cursor-pointer hover:bg-gray-300" onClick={navigateHandler}>
                            <LeftArrow />
                        </div>
                    ...
                    <div className="flex h-16  w-full pt-2">
                        <button
                            ...
                            Followers{type === "followers" && <div className="  mt-[0.8rem] w-[3.4rem] rounded-3xl border-[0.15rem] border-blue-500  "></div>}
                        </button>
                        <button
                            ...
                            Following{type === "following" && <div className="  mt-[0.8rem] w-[3.4rem] rounded-3xl border-[0.15rem] border-blue-500  "></div>}
                        </button>
                    </div>
                </div>
            </div>
...
export const FollowersFollowingStructure = ({ user, state, dispatchFollowUser, ACTIONS, dispatch }) => {
    const navigate = useNavigate();
    ...
    return (
        <>
            <div onClick={() => navigateHandlerToProfile(user.handle)} className="flex cursor-pointer items-start gap-3 p-3 hover:bg-gray-100">
