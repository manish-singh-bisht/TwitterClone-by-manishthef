...
const Avatar = ({ profile }) => {
    ...
    return (
        <>
            {profile ? (
                imageLoaded ? (
                    <div className="relative z-[5] m-1 h-[3.2rem] w-[3.2rem] items-center justify-center rounded-full   bg-gray-400">
                        <img src={profile} alt="profile image" loading="lazy" className="h-full w-full rounded-full object-cover" />
                    </div>
                ) : (
                    <>
                        <div className="relative z-[5] h-[3.2rem] w-[3.2rem]  overflow-hidden rounded-full">
                ...
                <div className="relative z-[5] m-1 flex h-[3.2rem] w-[3.2rem] items-center justify-center  rounded-full bg-gray-200">
